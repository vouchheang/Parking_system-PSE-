...
//                             if (token != null) {
//                               // User already logged in, redirect to appropriate home/navigation
//                               switch (_selectedRole!) {
//                                 case UserRole.user:
//                                   nextScreen = HomeScreen(widget.userId);
//                                   break;
//                                 case UserRole.admin:
//                                   nextScreen =
...
//                               }
//                             } else {
//                               // New or unauthenticated user - go to login screen
//                               switch (_selectedRole!) {
//                                 case UserRole.user:
//                                   nextScreen =
//                                       ParkingRegistrationScreen(); // or ParkingRegistrationScreen if intended
//                                   break;
//                                 case UserRole.admin:
//                                   nextScreen = LoginScreen(
//                                     role: _getRoleString(UserRole.admin),
//                                     userId: widget.userId,
//                                   );
//                                   break;
